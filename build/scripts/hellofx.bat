...
set DEFAULT_JVM_OPTS="--add-modules" "javafx.controls,javafx.fxml" "--module-path" "%APP_HOME%\lib" "--module" "hellofx/org.openjfx.MainApp"
...
@rem Execute hellofx
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HELLOFX_OPTS%  -classpath "%CLASSPATH%" hellofx/org.openjfx.MainApp %CMD_LINE_ARGS%
